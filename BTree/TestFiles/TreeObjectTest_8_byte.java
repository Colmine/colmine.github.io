...
/**
 * Testing for instances of TreeObject<Byte> class
 * 
 * @author Cole Gilmore
 *
 */
public class TreeObjectTest_8_byte {
	//TreeObject object running tests on
	TreeObject<Byte> treeObject;
	...
	private static final String BK6 = "Key: " + TestCase.K_2;
	...
	public void initialize() {
		//Create TreeObject
		treeObject = new TreeObject<Byte>(KEY);
	}
	...
	{
		TestCase.toString(treeObject, VALUE, BK6);
	}
