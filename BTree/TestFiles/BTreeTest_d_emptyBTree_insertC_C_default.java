...
public class BTreeTest_d_emptyBTree_insertC_C_default {
...
//	private static final File DUMP = new File("dump.txt");
	...
	public void initialize()
	{
		...
		treeNode2.setKeys(COUNT2, TOBJ13);
		RAF = bTree.create();
		try {
	...
	{
		TestCase.testInsert(bTree, treeNode, TOBJ13);
	}
	...
	{
		TestCase.testSplitChild(bTree, treeNode, treeNode, COUNT);
	}
	 ...
	 * Expected Result: returns 12
	 */
	@Test()
	public void testGetSize()
	{
		TestCase.testGetSize(bTree, 12);
	}
	
	/**
	 * Test: incSize - increments size value by 1
	 * Expected Result: returns 13
	 */
	@Test()
	public void testIncSize()
	{
		TestCase.testIncSize(bTree, 13);
	}
