...
public class TreeNodeTest_7_sixObjInNode {
	...
	private static final TreeObject<String> TREEOBJECT = TestCase.AGA;
	private static final TreeObject<String> TOBJ2 = TestCase.ATA;
	private static final TreeObject<String> TOBJ3 = TestCase.AAA;
	private static final TreeObject<String> TOBJ4 = TestCase.CGC;
	private static final TreeObject<String> TOBJ5 = TestCase.TCT;
	private static final TreeObject<String> TOBJ6 = TestCase.TGT;
	private static final TreeObject<String> TOBJ7 = TestCase.CAC;
	private static final TreeObject<String> TOBJ8 = TestCase.TTT;
	private static final TreeObject<String> TOBJ9 = TestCase.GGG;
	private static final TreeObject<String> TOBJ10 = TestCase.CCT;
	private static final TreeObject<String> TOBJ11 = TestCase.AAT;
	//TreeObject arrays to check with
	private static final TreeObject<String>[] A_1 = TestCase.K_8N;
	private static final TreeObject<String>[] A_2 = TestCase.K_8N2;
	private static final TreeObject<String>[] A_3 = TestCase.K_8N3;
	//Long value array to check testNode
	private static final long[] E_CHILDREN = new long[8];	
	//Long value array to check treeNode
	private static final long[] CHILDREN = new long[] {0L, 11L, 0L, 0L, 0L, 0L, 10L, 0L};
	...
	public void initialize()
	{
		...
		treeNode.setKeys(COUNT6, TOBJ11);
		treeNode.setChildren(COUNT, CHILD);
		treeNode.setChildren(COUNT6, CHILD2);
	...
	{
		TestCase.testGetCount(treeNode, COUNT6);
	...
	{
		TestCase.testIncCount(treeNode, COUNT7);
	...
	{
		TestCase.testSetCount(treeNode, COUNT7, COUNT7);
