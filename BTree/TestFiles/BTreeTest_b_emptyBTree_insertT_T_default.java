...
public class BTreeTest_b_emptyBTree_insertT_T_default {
...
//	private static final File DUMP = new File("dump.txt");
	...
	public void initialize()
	{
		...
		treeNode.setChildren(COUNT, treeNode1.getOffSet());
		...
		treeNode1.setKeys(COUNT, TOBJ4);
		treeNode2.setKeys(COUNT2, TOBJ4);
		RAF = bTree.create();
		try {
	 ...
	 * Expected Result: returns the root node
	 */
	@Test()
	...
	{
		TestCase.testInsert(bTree, treeNode1, TOBJ4);
	}
	 ...
	 * Expected Result: Full node/array, ArrayIndexOutOfBounds exception
	 */
	@Test(expectedExceptions = ArrayIndexOutOfBoundsException.class)
	public void testInsertNonFull()
	{
		TestCase.testInsertNonFull(bTree, treeNode, TOBJ3.getKey());
	}
...
//	}
	...
	{
		TestCase.testDelete(bTree, treeNode, TOBJ4);
	}
