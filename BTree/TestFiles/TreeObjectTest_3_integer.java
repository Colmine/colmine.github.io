...
/**
 * Testing for instances of TreeObject<Integer> class
 * 
 * @author Cole Gilmore
 *
 */
public class TreeObjectTest_3_integer {
	//TreeObject object running tests on
	TreeObject<Integer> treeObject;
	
	//************* Constants used in tests******************//
	//Value in TreeObject
	private static final Integer VALUE = TestCase.I_12;
	//Key for value in TreeObject
	private static final long KEY = TestCase.K_5;
	//New key for TreeObject
	private static final long NEW_KEY = TestCase.K_4;
	//String value to test toString from TreeObject
	private static final String IK5 = "Key: " + TestCase.K_5;
	...
	public void initialize() {
		//Create TreeObject
		treeObject = new TreeObject<Integer>(KEY);
	}
	...
	{
		TestCase.toString(treeObject, VALUE, IK5);
	}
