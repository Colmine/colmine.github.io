...
/**
 * Testing for instances of TreeObject<Boolean> class
 * 
 * @author Cole Gilmore
 *
 */
public class TreeObjectTest_7_boolean {
	//TreeObject object running tests on
	TreeObject<Boolean> treeObject;
	
	//************* Constants used in tests******************//
	//Value in TreeObject
	private static final Boolean VALUE = TestCase.B_false;
	...
	private static final String BK4 = "Key: " + TestCase.K_4;
	...
	public void initialize() {
		//Create TreeObject
		treeObject = new TreeObject<Boolean>(KEY);
	}
	...
	{
		TestCase.toString(treeObject, VALUE, BK4);
	}
