...
public class TreeObjectTest_5_float {
	...
	public void initialize() {
		//Create TreeObject
		treeObject = new TreeObject<Float>(KEY);
	}
	...
	{
		TestCase.toString(treeObject, VALUE, FK3);
	}	
